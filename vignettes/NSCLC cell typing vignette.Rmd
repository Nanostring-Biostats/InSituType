...
unsup <- insitutype(counts = mini_nsclc$counts,
                    ...
                    init_clust = NULL, 
                    n_clusts = c(5,10,15,20),  # condensed to save time. n_clusts = 5:20 would be more optimal
                    fixed_profiles = NULL,
                    anchors = NULL,
                    nb_size = 10,
                    n_starts = 5)   
...
cols <- c('#8DD3C7','#FFFFB3','#BEBADA','#FB8072','#80B1D3','#FDB462','#B3DE69','#FCCDE5','#D9D9D9','#BC80BD','#CCEBC5','#FFED6F','#E41A1C','#377EB8','#4DAF4A','#984EA3','#FF7F00','#FFFF33','#A65628','#F781BF','#999999')
...
- supervised cell typing: 
- semi-sup
- anchor cells - automated, or a custom example
- flightpath
- mergecells
